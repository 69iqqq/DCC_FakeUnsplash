        ...
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            <MDBCol md='3' lg='4' xl='3' className='mx-auto mb-4'>
              ...
              <p>
                Thank you for exploring Fake Unplasshhh,DCC-NITA project!
                Dreaming of joining DCC feels like a professional aspiration,
                and I hope to make that dream a reality through hard work and
                dedication. Here's to striving for excellence in every endeavor!
              </p>
            </MDBCol>
